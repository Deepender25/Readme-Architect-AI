  ...
  const steps = [
    {
      ...
      description: "Start by connecting your GitHub repository to AutoDoc AI. Simply paste your repository URL or select from your connected repositories.",
      details: [
      ...
      <div className="min-h-screen py-12">
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <h1 className="text-4xl font-bold text-white mb-4">How to Use AutoDoc AI</h1>
            ...
            <div className="bg-gradient-to-r from-green-400/10 to-green-600/10 border border-green-400/20 rounded-xl p-8">
              ...
              <div className="bg-black/40 rounded-lg p-8 text-center">
                ...
                <p className="text-gray-300 mb-4">
                  Watch our quick 2-minute tutorial to get started with AutoDoc AI
                </p>
          ...
          >
            <div className="text-center mb-12">
              ...
              <p className="text-gray-400">Get the best results from AutoDoc AI with these expert tips</p>
            </div>
          ...
          >
            <div className="text-center mb-12">
              ...
              <p className="text-gray-400">Common questions about using AutoDoc AI</p>
            </div>

            <div className="space-y-6">
              {[
                {
                  q: "What types of projects work best with AutoDoc AI?",
                  a: "AutoDoc AI works with all types of software projects - web applications, mobile apps, APIs, libraries, and more. It's particularly effective with projects that have clear folder structures and dependency files."
                },
                {
