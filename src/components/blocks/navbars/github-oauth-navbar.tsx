            ...
            <AnimatePresence mode="wait">
              {!isAuthenticated ? (
                <motion.button
                  ...
                  onClick={() => login()}
                  disabled={isLoading}
                  className="relative flex items-center gap-2 px-4 py-2 text-sm font-medium text-green-500 border border-green-500/50 rounded-lg overflow-hidden group hover:border-green-500/80 transition-all duration-200 disabled:opacity-50 w-48"
                >
