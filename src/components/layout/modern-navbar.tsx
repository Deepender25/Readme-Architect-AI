                ...
                {!isAuthenticated ? (
                  ...
                  >
                    <motion.button
                      ...
                      className="flex items-center gap-3 px-4 py-1.5 text-sm font-medium glass-button rounded-xl transition-all duration-300 hover:shadow-lg hover:shadow-green-400/20 group"
                    >
